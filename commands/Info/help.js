...
module.exports = {
  ...
  help.addFields(
    { name: '\u200B', value: '\u200B' },
    { name: '**Search Commands**', value: '` \' help search`',inline: true },
  ...
  help.setFooter('My prefixes are \' , COOKIE, k! and l!')
message.channel.send(help);
  ...
  if(args[0] === "image"){
    ...
    const update = new Discord.MessageEmbed();
    update.setTitle('Search help' )
    update.setColor('RANDOM')
    update.setThumbnail('https://cdn.discordapp.com/avatars/748778813357555733/f1acd65fdf22a6c1187e445179ec431b.png?size=256')
    
    update.setDescription('``` \' def (word)```')
    ...
    update.setColor('RANDOM')
    update.setThumbnail('https://cdn.discordapp.com/avatars/748778813357555733/f1acd65fdf22a6c1187e445179ec431b.png?size=256')
    update.setDescription('```\' weather (city), \' corona (country) , \' invite, \' vote, \' binary (number), \' decode (binary number)```')
    ...
    update.setColor('RANDOM')
    update.setThumbnail('https://cdn.discordapp.com/avatars/748778813357555733/f1acd65fdf22a6c1187e445179ec431b.png?size=256')
    update.setDescription('```\n \' rps, \' love <mention>, \' gay <mention>, \' joke, \' 8ball <question>, \' banner <text> \n ```')
